...
def verificar_login():
    ...
    if usuario == "julia" and senha == "corinthians":
        messagebox.showinfo("Login", "TA CERTO GOSTOSAAAAA(O)")
    else:
        messagebox.showerror("Erro", "TA ERRADO BURRO DO CARALHO POEM A SENHA CERTA,CETEZA QUE É PALMEIRENSE")
...
# Estilo ne pae
style = ttk.Style()
style.configure("TLabel", background="#blue", foreground="white", font=("verdana", 12))
